...
public class WebSocketService {
    ...
    public static class PlayerJoinedData {
        ...
        public PlayerJoinedData(String playerName) { this.playerName = playerName; }
    }
    
    public static class CardPlayedData {
        public final String cardDescription;
        public CardPlayedData(String cardDescription) { this.cardDescription = cardDescription; }
    }
    
    public static class CardDrawnData {
        public final int cardCount;
        public CardDrawnData(int cardCount) { this.cardCount = cardCount; }
    }
    
    public static class UnoCalledData {
        public final String playerName;
        public UnoCalledData(String playerName) { this.playerName = playerName; }
    }
    
    public static class GameWonData {
        public final String winnerName;
        public GameWonData(String winnerName) { this.winnerName = winnerName; }
    }
    
    public static class GameStartedData {
        public final int playerCount;
        public GameStartedData(int playerCount) { this.playerCount = playerCount; }
    }
}
